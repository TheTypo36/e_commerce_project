...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | Sale | OrderType | ProductType | Category | Slug | BlockContent | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata;
...
// Query: *[_type == "productType" && slug.current == $slug] | order(name asc)
...
// Query: *[_type == "sale" && couponCode == $couponCode && isActive == true] | order(validFrom desc){        title,        description,        discountAmount,        couponCode,        validFrom,        validUntil,        isActive    }[0]
